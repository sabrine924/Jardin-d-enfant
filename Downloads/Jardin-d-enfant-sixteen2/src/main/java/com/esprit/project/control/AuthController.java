...
import com.esprit.project.payload.request.LoginRequest;
import com.esprit.project.payload.request.SignupRequest;
import com.esprit.project.payload.response.JwtResponse;
import com.esprit.project.payload.response.MessageResponse;
import com.esprit.project.repository.RoleRepository;
import com.esprit.project.repository.UserRepository;
import com.esprit.project.security.jwt.JwtUtils;
import com.esprit.project.service.UserDetailsImpl;
		...
		if (strRoles == null) {
			...
			strRoles.forEach(role -> {
				...
				case "admin":
					...
					break;
				case "kindergarden":
					Role kindergardenRole = roleRepository.findByName(ERole.ROLE_KINDERGARDEN)
							.orElseThrow(() -> new RuntimeException("Error: Role is not found."));
					roles.add(kindergardenRole);
